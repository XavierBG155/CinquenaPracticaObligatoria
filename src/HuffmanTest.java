...
public class HuffmanTest {
    ...
    public void compress() throws Exception {
        ...
        // Només un caràcter
        ar = "AAAAAAAAA".getBytes();
        assertArrayEquals(new byte[]{0,0}, comp(ar) );

        // Buit
        ar = "".getBytes();
        assertArrayEquals(new byte[]{}, comp(ar) );
    }
    ...
    public void testFile() throws Exception {
        ...
        assertEquals("1fa261d99508f6947f8a754ac57f7888", Utils.md5(new File(s2)));
    }
